...
| **RES-RED-10** | 2026-08-29 | DELEGASI_040 | Mengimplementasikan model friksi mikrostruktur realistis (`spread_pct`, `slippage_pct`, `commission_pct`) pada `BacktestEngine`, menghitung turnover posisi per bar dan rincian biaya transaksi. |
| **RES-RED-11** | 2026-08-29 | DELEGASI_040 | Mengimplementasikan metode Circular Block Bootstrap Monte Carlo pada `monte_carlo_simulation()`, mempertahankan autokorelasi serial dan pengelompokan volatilitas nyata pasar. |
