...
Status: **NORMATIVE APPENDIX / SUPERSET-CLOSED ENUMERATION / MEMBER OF MANIFEST V40+ / NO IMPLEMENTATION AUTHORITY**  
...
```text
ARE-1 CLOSED @a6711d6 | ARE-2 IMPLEMENTATION = NOT AUTHORIZED sampai
IMPLEMENTATION_AUTHORITY_CHARTER_ARE2 RATIFIED oleh owner (T4).
