...
```text
CURRENT_NORMATIVE_MANIFEST_PATH = PROJECT_GOVERNANCE/ARE0/MANIFEST/AHFMES_ARE_0_NORMATIVE_AUTHORITY_MANIFEST_V39.md
CURRENT_NORMATIVE_MANIFEST_GENERATION = 39
```
