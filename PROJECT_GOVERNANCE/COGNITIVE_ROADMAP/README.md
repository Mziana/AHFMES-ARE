...
```text
┌─────────────────────────────────────────────────────────────────────────────┐
│ MASTER ROADMAP AHFMES-ARE (STATUS SAAT INI)                                 │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
...
## 📁 Subfolder Tata Kelola (Standard Mirror)

| Folder | Isi & Dokumen Kunci | Status |
|---|---|:---:|
| `GRAND_DESIGN/` | Master Cognitive Cannibalization Roadmap V1 | RATIFIED ✅ |
| `AUTHORITY_AND_WORKFLOW/` | Catatan Mandat Delegasi (DELEGASI_025 s/d 033) | RECORDED ✅ |
| `CONTRACTS/` | Kontrak Invarian Keamanan, Vault, dan Purifier | ACTIVE ✅ |
| `MACHINE/` | Sumber mesin kanonikal | `.gitkeep` |
| `MANIFEST/` | Normative Manifest Binding | Active V41 Binding |
| `COUNCIL_PROTOCOL/` | Protokol Audit 5-Dimensi Dampak Lintas Sistem | RATIFIED ✅ |
| `QUARANTINE/` | Catatan isolasi / karantina dependensi pihak ketiga | POLARS / PYDANTIC BOUNDED |
| `R9_CORRECTIONS/` | Catatan koreksi mikro & attack impact | RECORDED |
| `EXTERNAL_AUDIT/` | Handoff & Laporan audit eksternal | `.gitkeep` |
| `QUALIFICATION/` | Bukti kualifikasi & Audit Log (336/336 Pass) | QUALIFIED ✅ |
| `DIARY/` | Jurnal kronologis gelombang kognitif | APPEND-ONLY |

---

## 📌 Titik Baca Cepat

1. **Entry Point Otoritas:** `../CURRENT_AUTHORITY_INDEX.md`
2. **Master Grand Design:** `GRAND_DESIGN/AHFMES_ARE_COGNITIVE_CANNIBALIZATION_ROADMAP_V1.md`
3. **Ledger Residu:** `RESIDUAL_REGISTER.md`
4. **Indeks Progres Global:** `../../PROJECT_JOURNAL/DIARY/GLOBAL_PROGRESS_DIARY.md`
