...
def test_oos_overlap_rejection():
    ...
    ev = WFOEvidence(
        ...
        warmup_bars=0,
        pooled_oos_returns=(0.0, 0.0),
        pooled_oos_equity=(1.0, 1.0, 1.0),
        pooled_oos_sharpe=1.0,
        pooled_oos_return=0.0,
        pooled_oos_max_drawdown=0.0,
...
def test_final_gate_permutations(mock_val):
    ...
    def make_ev(pooled_sharpe, p_val_adjust=False):
        ...
        ev_proto = WFOEvidence(
            ...
            label_horizon_unit="BARS",
            warmup_bars=0,
            pooled_oos_returns=tuple([0.0]*1000),
            pooled_oos_equity=tuple([1.0]*1001),
